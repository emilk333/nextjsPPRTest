...
const CartCountContext = React.createContext<| [null | number, React.Dispatch<React.SetStateAction<null | number>>]| undefined>(undefined);
...
export function useCartCount(initialCount: number): [null | number, React.Dispatch<React.SetStateAction<null | number>>] {
